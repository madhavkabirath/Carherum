...
export default function Ettiga() {
    ...
    <div>
      <div className="flex flex-row bg-white py-2 ">
        <div className="w-[50%] h-[50%] ">
          <Link href={"Hyundai_I20N-lineimages"}>
            <img
              className="rounded-md w-[60%] e-[50%] px-4"
              src="/assets/images/Maruti/Ettiga.jpeg"
            ></img>
          </Link>
        </div>
        <div className="mt-4 -mx-6">
          <h1 className="text-black-500">Maruti Ettiga</h1>
      ...
      <div className="p-6 m-4 bg-slate-200  ">
        <h1 className="text-2xl">Key Specs of Maruti Ettiga</h1>
      ...
      <div className="p-6 m-4 bg-slate-100 shadow-md border-2 rounded-md">
        <h1 className="text-2xl text-bold">Maruti Ettiga Car Latest Update</h1>
        <p className="py-2">
          {isExpanded ? (
            <>
              <strong className="text-slate-600">Latest Update:</strong>Maruti has
            ...
            <>
              <strong className="text-slate-600">Latest Update:</strong>{" "}
              Mahindra has launched the facelifted M340i in Nepal. It now gets a
              crisper look and an updated cabin with new displays.
              <br />
              <strong className="text-slate-600">Price:</strong> The facelifted

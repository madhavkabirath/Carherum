  ...
  return (
    <div>
        ...
        <div className="w-[50%] h-[50%] ">
          <Link href={"Grandi10images"}>
            <img
              ...
              src="/assets/images/Renault/Kiger.jpeg"
            ></img>
          </Link>
        </div>
        <div className="mt-4 -mx-6">
          <h1 className="text-black-500">Renoul Kiger</h1>
      ...
      <div className="p-6 m-4 bg-slate-200  ">
        <h1 className="text-2xl">Key Specs of Kiger</h1>

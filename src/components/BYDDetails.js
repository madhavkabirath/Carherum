...
const data = [
  {
    id: 1,
    title: "BYD Atto 3",
    imageSrc: "/assets/images/BYD/atto3.jpeg",
    description: "Rs 50-70 lakhs*",
    Link:"/BYD_Atto",
  },
  {
    id: 2,
    title: "BYD Tang EV",
    imageSrc: "/assets/images/BYD/TangEv.jpeg",
    description: "Rs 54-65 lakhs*",
    Link:"/BYD_Tang",
  },
  {
    id: 3,
    title: "BYD E6",
    imageSrc: "/assets/images/BYD/E6.jpeg",
    description: "Rs 30-50 lakhs*",
    Link:"/BYD_E6",
  },
  {
    id: 4,
    title: "BYD Seagull",
    imageSrc: "/assets/images/BYD/Seagull.jpeg",
  ...
  },
  {
    id: 5,
    title: "BYD Seal",
    imageSrc: "/assets/images/BYD/Seal.jpeg",
...
export default function BYDDetails() {
  return (
    <div className="border-2 flex  ">
      <div className=" p-4 m-6 ">
        {/* top text place */}
        <div className="border-2 ">
          <h1 className="text-3xl">BYD Car in 2024</h1>
          <p className="text-slate-500 p-2 ">
            There are a total of 2 BYD models currently on sale in Nepal. These
            include 1 MUV and 1 SUV. BYD has 2 upcoming car launches in Nepal -
            the BYD Seal, BYD Seagull.
          </p>
        </div>
        <div className="flex flex-nowrap">
          <div className="flex w-full justify-around">
            <div className="w-full">
              <h1 className="text-3xl p-2">BYD Models</h1>{" "}
              {data.map((items) => {
                return (

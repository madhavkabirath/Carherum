...
const data = [
  {
    ...
    imageSrc: "/assets/images/Tesla/Cybertruck.jpeg",
    description: "Rs 20-40 lakhs*",
    Link:"/Tesla_Cyber-Truck",
  },
  {
    id: 2,
    title: "Tesla Model 2",
    imageSrc: "/assets/images/Tesla/Model-2.jpeg",
    ...
    <div className="border-2 flex  ">
      <div className=" p-4 m-6 ">
        ...
        <div className="border-2 ">
          <h1 className="text-3xl">Tesla Car in 2024</h1>
          <p className="text-slate-500 p-2 ">
            Tesla Motors, one of the biggest names in the automobile industry,
            is an American electric car manufacturer. The company was founded by
            Martin Eberhard and Marc Tarpenning in 2003. The company is named
            after Nikola Tesla, a physicist and an electrical engineer.
          </p>
        </div>
        <div className="flex flex-nowrap">
          <div className="flex w-full justify-around">
            <div className="w-full">
              <h1 className="text-3xl p-2">Tesla Models</h1>{" "}
              {data.map((items) => {
                return (

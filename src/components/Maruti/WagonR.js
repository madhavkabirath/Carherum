  ...
  return (
    <div>
        ...
        <div className="w-[50%] h-[50%] ">
          <Link href={"Hyundai_I20N-lineimages"}>
            <img
              ...
              src="/assets/images/Maruti/WagonR.jpeg"
            ></img>
          </Link>
        </div>
        <div className="mt-4 -mx-6">
          <h1 className="text-black-500">Maruti WagonR</h1>
      ...
      <div className="p-6 m-4 bg-slate-200  ">
        <h1 className="text-2xl">Key Specs of Maruti WagonR</h1>
      ...
      <div className="p-6 m-4 bg-slate-100 shadow-md border-2 rounded-md">
        <h1 className="text-2xl text-bold">Maruti WagonR Car Latest Update</h1>
        <p className="py-2">
          {isExpanded ? (
            <>

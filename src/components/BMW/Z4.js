    ...
    <div>
      <div className="flex flex-row bg-white py-2 ">
        ...
        <div className="mt-4 -mx-6">
          <h1 className="text-black-500">BMW Z4</h1>
      ...
      <div className="p-6 m-4 bg-slate-200  ">
        <h1 className="text-2xl">Key Specs of BMW Z4</h1>
          ...
          <CustomTabPanel value={value} index={0}>
            <Table hideHeader aria-label="Example static collection table">
              ...
              <TableBody>
                ...
                <TableRow key="2">
                  <TableCell>
                    <a className="flex -mx-2 ">
                      <PiEngineThin className="mx-2 text-2xl" />
                      Engine
                    </a>
                  </TableCell>
                  ...
                  <TableCell>
                    <a className="flex">
                      <ImPower className="mx-2 text-sm my-2" />
                      Power
                    </a>
                  </TableCell>
                ...
                <TableRow key="3">
                  <TableCell>
                    <a className="flex -mx-2">
                      <MdOutlineChangeCircle className="mx-2 text-2xl" />
                      Torque{" "}
                    </a>
                  </TableCell>
                  ...
                  <TableCell>
                    <a className="flex">
                      <GiGearStick className="mx-2" /> Transmission{" "}
                    </a>
                  </TableCell>
                ...
                <TableRow key="4">
                  ...
                  <TableCell>
                    <a className="flex">
                      <PiSteeringWheelThin className="mx-2 text-2xl" />
                      Drive Type
                    </a>
                  </TableCell>
      ...
      <div className="p-6 m-4 bg-slate-100 shadow-md border-2 rounded-md">
        <h1 className="text-2xl text-bold">BMW Z4 Car Latest Update</h1>
        <p className="py-2">
          {isExpanded ? (
            <>

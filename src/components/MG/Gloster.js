...
export default function Gloster() {
  ...
  return (
    <div>
        ...
        <div className="w-[50%] h-[50%] ">
          <Link href={"Hyundai_I20N-lineimages"}>
            <img
              ...
              src="/assets/images/MG/Gloster.jpeg"
            ></img>
          </Link>
        </div>
        <div className="mt-4 -mx-6">
          <h1 className="text-black-500">MG Gloster</h1>
      ...
      <div className="p-6 m-4 bg-slate-200  ">
        <h1 className="text-2xl">Key Specs of MG Gloster</h1>

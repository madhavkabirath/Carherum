...
const data = [
  {
    id: 1,
    title: "Jeep Avenger",
    imageSrc: "/assets/images/jeep/Avenger.jpeg",
  ...
  },
  {
    id: 2,
    title: "Jeep Compass",
    imageSrc: "/assets/images/jeep/compass.jpeg",
  ...
  },
  {
    id: 3,
    title: "Jeep Grand",
    imageSrc: "/assets/images/jeep/grand.jpeg",
    description: "Rs 22-45 lakhs*",
    Link:"/Jeep_Grand",
  },
  {
    id: 4,
    title: "Jeep Meridian",
    imageSrc: "/assets/images/jeep/meridian.jpeg",
  ...
  },
  {
    id: 5,
    title: "Jeep Wrangler",
    imageSrc: "/assets/images/jeep/wrangler.jpeg",
    description: "Rs 22-45 lakhs*",
    Link:"/Jeep_Wrangler",
  },
];
...
export default function JeepDetails() {
  return (
    <div className="border-2 flex  ">
      <div className=" p-4 m-6 ">
        {/* top text place */}
        <div className="border-2 ">
          <h1 className="text-3xl">Jeep Car in 2024</h1>
          <p className="text-slate-500 p-2 ">
            There are a total of 4 Jeep models currently on sale in Nepal. These
            include 4 SUVs. Jeep has 3 upcoming car launches in Nepal - the Jeep
            Wrangler 2024, Jeep Avenger, Jeep Sub-4m SUV.
          </p>
        </div>
        <div className="flex flex-nowrap">
          <div className="flex w-full justify-around">
            <div className="w-full">
              <h1 className="text-3xl p-2">Jeep Models</h1>{" "}
              {data.map((items) => {
                return (

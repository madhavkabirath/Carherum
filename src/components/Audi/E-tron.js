...
export default function E_tron() {
  ...
  return (
    <div>
        ...
        <div className="w-[50%] h-[50%] ">
          <Link href={"I7images"}>
            <img
              ...
              src="/assets/images/Audi/e-tron.jpeg"
            ></img>
          </Link>
        </div>
        <div className="mt-4 -mx-6">
          <h1 className="text-black-500">Audi E_tron</h1>
      ...
      <div className="p-6 m-4 bg-slate-200  ">
        <h1 className="text-2xl">Key Specs of Audi</h1>
      ...
      <div className="p-6 m-4 bg-slate-100 shadow-md border-2 rounded-md">
        <h1 className="text-2xl text-bold">Audi E-tron Car Latest Update</h1>
        <p className="py-2">
          {isExpanded ? (
            <>
              <strong className="text-slate-600">Latest Update:</strong> Audi has

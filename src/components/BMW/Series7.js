    ...
    <div>
      <div className="flex flex-row bg-white py-2 ">
        <div className="w-[50%] h-[50%] ">
          <Link href={"BMWseries7Image"}>
            <img
              className="rounded-md w-[60%] h-[50%] px-4"
              src="/assets/images/BMW/i7/front-view.jpeg"
            ></img>
          </Link>
        </div>
        <div className="mt-4 -mx-6">
          <h1 className="text-black-500">BMW Series 7</h1>
      ...
      <div className="p-6 m-4 bg-slate-200  ">
        <h1 className="text-2xl">Key Specs of BMW Series 7</h1>
          ...
          <CustomTabPanel value={value} index={0}>
            <Table hideHeader aria-label="Example static collection table">
              ...
              <TableBody>
                ...
                <TableRow key="2" >
                  <TableCell ><a className="flex -mx-2 "><PiEngineThin className="mx-2 text-2xl"/>Engine</a></TableCell>
                  <TableCell>2993cc-2998cc</TableCell>
                  <TableCell><a className="flex"><ImPower className="mx-2 text-sm my-2" />Power</a></TableCell>
                  <TableCell>375.78 bhp</TableCell>
                </TableRow>
                <TableRow key="3">
                  <TableCell><a className="flex -mx-2"><MdOutlineChangeCircle className="mx-2 text-2xl"/>Torque </a></TableCell>
                  <TableCell>500Nm</TableCell>
                  <TableCell><a className="flex"><GiGearStick className="mx-2"/> Transmission </a></TableCell>
                  <TableCell>Automatic</TableCell>
                </TableRow>
                <TableRow key="4">
                  <TableCell><a className="flex -mx-2"><BsSpeedometer2 className="mx-2 text-2xl"/>Top Speed</a></TableCell>
                  <TableCell>253Kmph</TableCell>
                  <TableCell><a className="flex"><PiSteeringWheelThin className="mx-2 text-2xl" />Drive Type</a></TableCell>
      ...
      <div className="p-6 m-4 bg-slate-100 shadow-md border-2 rounded-md">
        <h1 className="text-2xl text-bold">BMW Series 7 Car Latest Update</h1>
        <p className="py-2">
          {isExpanded ? (
            <>
              <strong className="text-slate-600">Latest Update:</strong> BMW has
              launched the facelifted M740i in Nepal. It now gets a crisper look

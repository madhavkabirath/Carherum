    ...
    <div>
      <div className="flex flex-row bg-white py-2 ">
        ...
        <div className="mt-4 -mx-6">
          <h1 className="text-black-500">BMW Series 3</h1>
      ...
      <div className="p-6 m-4 bg-slate-200  ">
        <h1 className="text-2xl">Key Specs of BMW Series 3</h1>
      ...
      <div className="p-6 m-4 bg-slate-100 shadow-md border-2 rounded-md">
        <h1 className="text-2xl text-bold">BMW 3 Series Car Latest Update</h1>
        <p className="py-2">
          {isExpanded ? (
            <>

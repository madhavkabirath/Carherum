...
export default function Hyundai_Venue_N() {
    ...
    <div>
      <div className="flex flex-row bg-white py-2 ">
        <div className="w-[50%] h-[50%] ">
          <Link href={"Hyundai_Venue_Nimages"}>
            <img
              className="rounded-md w-[60%] h-[50%] px-4"
              src="/assets/images/Hyundai/VenueN/front-view.jpeg"
            ></img>
          </Link>
        </div>
        <div className="mt-4 -mx-6">
          <h1 className="text-black-500">Hyundai Venue N</h1>
      ...
      <div className="p-6 m-4 bg-slate-200  ">
        <h1 className="text-2xl">Key Specs of Hyundai Venue N</h1>
      ...
      <div className="p-6 m-4 bg-slate-100 shadow-md border-2 rounded-md">
        <h1 className="text-2xl text-bold">
          Hyundai Venue N Car Latest Update
        </h1>
        <p className="py-2">
          {isExpanded ? (
            <>
              <strong className="text-slate-600">Latest Update:</strong> Hyundai

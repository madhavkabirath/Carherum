...
const data = [
  {
    id: 1,
    title: "Maruti Alto",
    imageSrc: "/assets/images/Maruti/alto.jpeg",
    description: "Rs 30-45 lakhs*",
    Link:"/Maruti_Alto",
  },
  {
    id: 2,
    title: "Maruti Brezza",
    imageSrc: "/assets/images/Maruti/Brezza.jpeg",
  ...
  },
  {
    id: 3,
    title: "Maruti Dzire",
    imageSrc: "/assets/images/Maruti/Dzire.jpeg",
    description: "Rs 30-55 lakhs*",
    Link:"/Maruti_Dzire",
  },
  {
    id: 4,
    title: "Maruti Ettiga",
    imageSrc: "/assets/images/Maruti/Ettiga.jpeg",
  ...
  },
  {
    id: 5,
    title: "Maruti Swift",
    imageSrc: "/assets/images/Maruti/switf.jpeg",
    description: "Rs 22-45 lakhs*",
    Link:"/Maruti_Swift",
  },
  {
    ...
    imageSrc: "/assets/images/Maruti/WagonR.jpeg",
    description: "Rs 22-45 lakhs*",
    Link:"/Maruti_Wagon",
  },
...
export default function MarutiDetails() {
  return (
    <div className="border-2 flex  ">
      <div className=" p-4 m-6 ">
        {/* top text place */}
        <div className="border-2 ">
          <h1 className="text-3xl">Maruti Car in 2024</h1>
          <p className="text-slate-500 p-2 ">
            There are a total of 24 Maruti Suzuki models currently on sale in
            Nepal. These include 10 Hatchbacks, 1 Pickup Truck, 2 Minivans, 3
            Sedans, 4 SUVs and 4 MUVs. Maruti Suzuki has 6 upcoming car launches
            in India - the Maruti Suzuki Swift 2024, Maruti Suzuki Dzire 2024,
            Maruti Suzuki Swift Hybrid, Maruti Suzuki eVX, Maruti Suzuki XL5,
        ...
        <div className="flex flex-nowrap">
          <div className="flex w-full justify-around">
            <div className="w-full">
              <h1 className="text-3xl p-2">Maruti Models</h1>{" "}
              {data.map((items) => {
                return (

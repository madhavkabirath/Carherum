    ...
    <div className="p-6">
      <Box sx={{ width: "100%" }} className="p-2 border-2">
        <Box sx={{ borderBottom: 1, borderColor: "divider" }} className=" ">
          <div className="text-2xl text-bold mx-4 my-2">
            <h1>Most Search Car</h1>
          </div>
          <Tabs
            value={value}
          ...
          >
            <Tab label="Suv" {...a11yProps(0)} />

            <Tab label="Seden" {...a11yProps(1)} />
            <Tab label="Luxury" {...a11yProps(2)} />
          </Tabs>
        </Box>
        <CustomTabPanel value={value} index={0}>
          ...
          <Link href={"/SuvDetails"}>
            <h1 className="text-orange-500 mt-6 ">See all SUV cars</h1>
          </Link>
        </CustomTabPanel>
        ...
        <CustomTabPanel value={value} index={1}>
          ...
          <Link href={"/SedenDetails"}>
            <h1 className="text-orange-500 mt-6 ">See all Seden cars</h1>
          </Link>
        </CustomTabPanel>
        <CustomTabPanel value={value} index={2}>
          ...
          <Link href={"/LuxuryDetails"}>
            <h1 className="text-orange-500 mt-6 ">See all Luxury cars</h1>
          </Link>
        </CustomTabPanel>
      </Box>
    </div>

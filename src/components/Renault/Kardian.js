...
export default function Kardian() {
  ...
  return (
    <div>
        ...
        <div className="w-[50%] h-[50%] ">
          <Link href={"Grandi10images"}>
            <img
              ...
              src="/assets/images/Renault/Kardian.jpeg"
            ></img>
          </Link>
        </div>
        <div className="mt-4 -mx-6">
          <h1 className="text-black-500">Renoul Kardian</h1>
      ...
      <div className="p-6 m-4 bg-slate-200  ">
        <h1 className="text-2xl">Key Specs of Renault Kardian</h1>
      ...
      <div className="p-6 m-4 bg-slate-100 shadow-md border-2 rounded-md">
        ...
        <p className="py-2">
          {isExpanded ? (
            <>
              <strong className="text-slate-600">Latest Update:</strong>Renoult
